...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(483, 415)
        icon = QIcon()
        icon.addFile(u":/icons/icons/key.ico", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/lock-64.png", QSize(), QIcon.Disabled, QIcon.On)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/invisibility-64.png", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u":/icons/icons/visibility-64.png", QSize(), QIcon.Normal, QIcon.On)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/refresh-30.png", QSize(), QIcon.Normal, QIcon.On)
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/copy-64.png", QSize(), QIcon.Normal, QIcon.On)
        self.btn_copy.setIcon(icon4)
        self.btn_copy.setIconSize(QSize(32, 32))
